...
{
    internal class NamedEntityFA<TEntity> : EntityFA<TEntity> where TEntity : NamedEntity<TEntity>
    {
        public override void Configure(EntityTypeBuilder<TEntity> builder)
        {
            builder.OwnsOne(entity => entity.Name, SearchableStringVOFA.Map<TEntity>(true, MAX_LENGTH_PADRAO_DB));
